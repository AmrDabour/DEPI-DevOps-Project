# Integrate DevOps Project with AlloyDB
...
gcloud compute addresses create ${ALLOYDB_SERVICE_NAME} \
    ...
    --purpose=VPC_PEERING \
    --prefix-length=16 \
    --description="DevOps Project Private Services" \
...
## Deploy DevOps Project connected to an AlloyDB database

To automate the deployment of DevOps Project integrated with AlloyDB you can leverage the following variation with [Kustomize](../..).
